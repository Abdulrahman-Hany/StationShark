...
document.getElementById("img-mode").addEventListener("click", function () {
    if (firstClick) {
        firstClick = false;
        location.reload();
        return;
    ...
    // بعد الريفرش، سيتم تنفيذ الكود التالي تلقائيًا حسب حالة الـ body
    if ($('.body').hasClass('is_dark')) {
        document.getElementById("img-mode").src = "assets/images/icon/moon.png";
        document.getElementById("logo_header").src = "assets/images/logo/logo_dark.webp";
        document.getElementById("logo_footer").src = "assets/images/logo/logo_dark.webp";
