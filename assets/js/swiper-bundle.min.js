        ...
        if (t.enabled && (!t.animating || !n.preventInteractionOnTransition)) {
            ...
            (s.isTouchEvent || !("which"in d) || 3 !== d.which) && !(!s.isTouchEvent && "button"in d && d.button > 0 || s.isTouched && s.isMoved))) {
                ...
                if (n.noSwiping && (c ? function(e, t) {
                    ...
                    function t(a) {
                        return a && a !== r() && a !== l() ? (a.assignedSlot && (a = a.assignedSlot),
                        a.closest(e) || t(a.getRootNode().host)) : null
                    }(t)
            ...
            attachEvents: function() {
                ...
                if (!o.touch && o.pointerEvents)
                    ...
                    if (o.touch) {
                        ...
                        Y || (t.addEventListener("touchstart", V),
                        Y = !0)
                    }
            ...
            setBreakpoint: function() {
                ...
                if (l && (!l || 0 !== Object.keys(l).length)) {
                    ...
                    if (o && e.currentBreakpoint !== o) {
                        ...
                        (p.slidesPerColumnFill && "column" === p.slidesPerColumnFill || !p.slidesPerColumnFill && "column" === r.slidesPerColumnFill) && n.addClass(r.containerModifierClass + "multirow-column"),
    ...
    var j = {
        update: function(e) {
            ...
            for (var P = 0; P < c.length; P += 1)
                P >= y && P <= E && (void 0 === u || e ? S.push(P) : (P > u && S.push(P),
                P < p && C.push(P)));
    ...
    var J = {
      ...
      , ee = {
        update: function() {
            ...
            if (a.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                ...
                if ("fraction" === a.type && (r.find(P(a.currentClass)).text(a.formatFractionCurrent(i + 1)),
      ...
      , ne = {
        ...
        init: function() {
            ...
            l && l.length && (e.a11y.makeElFocusable(l),
            "BUTTON" !== l[0].tagName && (e.a11y.addElRole(l, "button"),
